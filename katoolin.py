...
4) View the contents of sources.list file
					...
					if repo == "1":
						...
						cmd2 = os.system("echo '# Kali linux repositories | Added by Katoolin\ndeb http://http.kali.org/kali kali-rolling main contrib non-free' >> /data/data/com.termux/files/usr/etc/apt/sources.list")
					elif repo == "2":
						cmd3 = os.system("apt-get update -m")
					elif repo == "3":
						infile = "/data/data/com.termux/files/usr/etc/apt/sources.list"
						outfile = "/data/data/com.termux/files/usr/etc/apt/sources.list"

						delete_list = ["# Kali linux repositories | Added by Katoolin\n", "deb http://http.kali.org/kali kali-rolling main contrib non-free\n"]
						fin = open(infile)
						os.remove("/data/data/com.termux/files/usr/etc/apt/sources.list")
						fout = open(outfile, "w+")
						for line in fin:
						...
						file = open('/data/data/com.termux/files/usr/etc/apt/sources.list', 'r')
